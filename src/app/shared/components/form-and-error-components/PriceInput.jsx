                    ...
                    <div className='m-3'>
                        <Form >
                            <div className=''>
                                ...
                                <Field id="minPrice" className='w-40 rounded-none rounded-b-md mb-4 shadow-inner' name="min" type="number" min={0} />
                            </div>
                            <div className=''>
                                <label name="max" className='p-3'>Max €</label>
                                <Field id="maxPrice" className='w-40 rounded-none rounded-b-md mb-4 shadow-inner' name="max" type="number"  min={0}/>
                            </div>
